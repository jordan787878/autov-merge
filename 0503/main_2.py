...
DATA_NAME = 'data1.txt'
LABEL = "0502_TaskC_LL_Belief_MergeFailCost"
...
DELTA_H1_H2 = np.array([18,24,30,36,
                        18,24,30,36,
                        18,24,30,36,
                        18,24,30,36,
                        18,24,30,36,
...
def main():
    for i in range(NUM_SIMU):
        print(i)
        simulation(X0_H1[i],DELTA_H1_H2[i])
